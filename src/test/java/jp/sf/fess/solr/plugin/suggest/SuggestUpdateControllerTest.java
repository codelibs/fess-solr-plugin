...
public class SuggestUpdateControllerTest extends TestCase {
    ...
    public void test_ttl_delete() {
        ...
        try {
            ...
            String prevDate = DateUtil.getThreadLocalDateFormat().format(new Date());
            ...
            doc2.setField(config.getExpiresField(), DateUtil.getThreadLocalDateFormat().format(new Date()));
            controller.add(doc2);
            controller.commit();
            Thread.sleep(5 * 1000);
