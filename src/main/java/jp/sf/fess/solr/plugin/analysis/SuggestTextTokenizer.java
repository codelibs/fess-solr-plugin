...
public class SuggestTextTokenizer extends Tokenizer {
    private static final Logger logger = LoggerFactory
            .getLogger(SuggestTextTokenizer.class);
    ...
    public SuggestTextTokenizer(final Reader input, final int bufferSize,
            ...
            final String wordSeparator, final int maxLength) {
        super(input);
    ...
    public boolean incrementToken() throws IOException {
        ...
        if (offset < termListByKuromoji.size()) {
            ...
            suggestStringList.add(convertSuggestString(
                    termListByKuromoji.get(offset), readingList.get(offset)));
            offset++;
        } else {
            ...
            if (tmpOffset < termListByKuromoji.size()) {
                ...
                if (buffer != null
                    ...
                    suggestStringList.add(convertSuggestString(
                            buffer.toString(), readingBuf.toString()));
            ...
            if (readingFlg) {
                if (readingOffset < suggestStringList.size()) {
                    termAtt.setEmpty();
                    termAtt.append(suggestStringList.get(readingOffset));
                    readingOffset++;
                } else {
                    return false;
                }
